...
UltraSQL enforces the visible policy form generated by the RAG helpers:
...
Broader RLS features remain open: role-qualified policies, `INSERT ... SELECT`
...
covered by a wire round-trip test.
