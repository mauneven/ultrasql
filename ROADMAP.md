...
- Broaden remaining `pg_stat_*` operator views, activity wait-event population,
  deeper lock/query timing precision, and production dashboards; completed base
  statistics views are tracked in `DONE.md`.
