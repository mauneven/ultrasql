...
fn xml_xpath_subset_filters_children_without_entity_resolution() {
    ...
    assert_eq!(
        xml_xpath_element_fragments("floor(/root/value)", r#"<root><value>42.5</value></root>"#),
    ...
    assert_eq!(
        xml_xpath_element_fragments("round(/root/value)", r#"<root><value>42.5</value></root>"#),
        Some(vec!["43".to_owned()])
    );
    assert_eq!(
        xml_xpath_element_fragments("round(/root/value)", r#"<root><value>-42.5</value></root>"#),
...
fn xml_xpath_subset_resolves_namespace_uri_aliases() {
    let doc = r#"<root xmlns="urn:root" xmlns:i="urn:item"><i:child i:id="7">z</i:child></root>"#;
    let namespaces = vec![
    ...
    assert_eq!(
        xml_xpath_element_fragments_with_namespaces("/r:root/item:child/text()", doc, &namespaces),
        Some(vec!["z".to_owned()])
    );
}
