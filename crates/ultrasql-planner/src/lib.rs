...
// Panic hardening: production (non-test) planner code must not `.unwrap()`,
...
pub use plan::{
    ...
    LogicalOnConflict, LogicalPivotAggregate, LogicalPivotValue, LogicalPlan, LogicalPrivilegeKind,
