...
//!
//! On Apple M-series the theoretical memory-bandwidth floor for
//! 160 MB scanned at ~80 GB/s is ~2 ms; this kernel targets that floor.
//!
//! Reproducibility:
//! ```text
...
use ultrasql_vec::filter_sum_i64_where_gt_zero;
