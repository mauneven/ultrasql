...
// Panic hardening: production (non-test) catalog code must not `.unwrap()`,
...
pub use entry::{
    ...
    decode_table_lookup_key, fold_identifier, index_lookup_key, table_lookup_key, type_lookup_key,
};
