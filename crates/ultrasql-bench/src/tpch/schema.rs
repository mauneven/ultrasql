...
/// Both engines receive the same DDL text; the `engine` parameter is reserved
/// for future dialect differences.
pub const fn ddl_for_engine(_engine: Engine) -> &'static [&'static str] {
    &[
