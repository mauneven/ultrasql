...
use super::{
    ...
    PG_OID_INT4, PG_OID_INT4_ARRAY, PG_OID_INT8, PG_OID_INT8_ARRAY, PG_OID_INTERVAL, PG_OID_JSON,
    PG_OID_JSON_ARRAY, PG_OID_JSONB, PG_OID_JSONB_ARRAY, PG_OID_MACADDR, PG_OID_MACADDR_ARRAY,
    PG_OID_MACADDR8, PG_OID_MACADDR8_ARRAY, PG_OID_MONEY, PG_OID_MONEY_ARRAY, PG_OID_NUMERIC,
    PG_OID_NUMERIC_ARRAY, PG_OID_OID, PG_OID_OID_ARRAY, PG_OID_PG_LSN, PG_OID_PG_LSN_ARRAY,
    PG_OID_REGCLASS, PG_OID_REGCLASS_ARRAY, PG_OID_REGTYPE, PG_OID_REGTYPE_ARRAY, PG_OID_TEXT,
    PG_OID_TEXT_ARRAY, PG_OID_TIME, PG_OID_TIME_ARRAY, PG_OID_TIMESTAMP, PG_OID_TIMESTAMP_ARRAY,
    PG_OID_TIMESTAMPTZ, PG_OID_TIMESTAMPTZ_ARRAY, PG_OID_TIMETZ, PG_OID_TIMETZ_ARRAY,
    PG_OID_TSQUERY, PG_OID_TSQUERY_ARRAY, PG_OID_TSVECTOR, PG_OID_TSVECTOR_ARRAY, PG_OID_UUID,
    PG_OID_UUID_ARRAY, PG_OID_VARBIT, PG_OID_VARBIT_ARRAY, PG_OID_VARCHAR, PG_OID_XML,
    PG_OID_XML_ARRAY,
};
