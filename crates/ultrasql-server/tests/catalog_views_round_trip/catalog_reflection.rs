//! End-to-end reflection of runtime objects through `pg_catalog` /
//! `information_schema`, plus background-maintenance statistics views.

use super::*;
use ultrasql_server::AutovacuumConfig;
