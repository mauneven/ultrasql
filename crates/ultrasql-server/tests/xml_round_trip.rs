            ...
            client
                .simple_query(
                    "SELECT \
                        ...
                        xpath('round(/root/value)', XML '<root><value>-42.5</value></root>'), \
                        xpath('sum(/root/value)', XML '<root><value>1.5</value><value>2.25</value></root>'), \
                        xpath('sum(/root/missing)', XML '<root><value>1.5</value></root>'), \
                        xpath('sum(/root/value)', XML '<root><value>1</value><value>bad</value></root>'), \
                        xpath('/root/item[position()=1]', XML '<root><item>a</item><item>b</item><item>c</item></root>'), \
