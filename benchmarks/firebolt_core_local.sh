...
FIREBOLT_CORE_DATA_DIR="${FIREBOLT_CORE_DATA_DIR:-${ULTRASQL_BENCH_SCRATCH:-${TMPDIR:-/tmp}/ultrasql-bench}/firebolt-core-data}"
FIREBOLT_CORE_DOCKER_CONFIG="${FIREBOLT_CORE_DOCKER_CONFIG:-${ULTRASQL_BENCH_SCRATCH:-${TMPDIR:-/tmp}/ultrasql-bench}/firebolt-core-docker-config}"
